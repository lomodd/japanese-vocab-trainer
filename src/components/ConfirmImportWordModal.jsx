...
export default function ConfirmImportWordModal({
  word,
  onCover,
  onSkip,
  onCoverAll,
  ...
  return (
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-lg p-6 w-96">
        <h2 className="text-lg font-bold mb-4 text-blue-600">发现重复单词</h2>
        <p className="mb-4">
          单词 <span className="font-semibold">“{word.word}”</span> 已存在，是否覆盖？
        </p>
